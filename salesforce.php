		...
		function config_page() {
			...
			if ( isset($_POST['submit']) ) {
				...
				if( isset( $_POST['mode'] ) && $_POST['mode'] == 'editform' ){
					...
					foreach (array('usecss','showccuser','ccadmin','captcha', 'commentstoleads', 'commentsnamefields') as $option_name) {
						if (isset($_POST[$option_name])) {
						...
						<div class="meta-box-sortables">
							...
							<form action="" method="post" id="salesforce-conf">
								...
								<?php
									...
									$content .= sprintf( '<p class="description">%s</p>', __( 'Using first and last name fields allows for cleaner Salesforce leads, otherwise the "first name" on the lead will contain the full name, but it may create issues with some WordPress themes.', 'salesforce' ) );
